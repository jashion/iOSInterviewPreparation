...
从上面的C++源代码可知，@autoreleasePool实际上调用的是objc_autoreleasePoolPush和objc_autoreleasePoolPop方法。具体关于AutoreleasePool的知识，可以前往[AutoreleasePool](../AutoreleasePool/AutoreleasePool.md)。
